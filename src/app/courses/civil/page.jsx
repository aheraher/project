 ...
 <div className='  flex flex-wrap items-start py-12 ' > 
  ...
  {data.map((course, index) => (
       <div key={index} className="w-full md:w-1/2 lg:w-1/3 p-4">
         <Link href= {`#`} className="block p-8 bg-gray-900 rounded-2xl  uppercase relative overflow-hidden h-60 transition duration-500 hover:bg-gray-800 hover:text-white group">
